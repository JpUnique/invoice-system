...
-- Transmittal Note: the document PetroData sends alongside (or referencing)
-- physically/digitally dispatched items (tapes, HDDs, reports, invoices) to
-- formally record what was sent, to whom, and confirm receipt. No sample was
-- provided for this one — the shape follows standard oil & gas industry
-- convention (see internal/pdf templates for the rendered layout).
